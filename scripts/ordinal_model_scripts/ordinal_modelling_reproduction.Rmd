...
dat <-
  bind_rows(read_csv(here(sprintf('data/processed/%s_predicted_curve_concurrent.csv', task_to_analyze)), show_col_types = FALSE) %>% mutate(conf_type = 'concurrent'),
            read_csv(here(sprintf('data/processed/%s_predicted_curve_delayed.csv', task_to_analyze)), show_col_types = FALSE) %>% mutate(conf_type = 'delayed'))
